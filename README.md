...
3. `PRIMER37_TEXT / PRIMER38_TEXT`: common snps annotation text
...
docker run -v /home/$USER/reference_files:/reference_files -v $PWD:/home/primer_designer/output --env-file {config-file) {image-name} python bin/primer_designer_region.py --chr 12 --pos 56489061 --grch37
